      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-brown-light leading-relaxed mb-6">
              That community support pushed them to grow. Today the Olsons
              keep hives in Steamboat, Hayden, and Denver, and each location
              brings its own character to the honey, shaped by whatever happens
              to be blooming nearby.
            </p>
